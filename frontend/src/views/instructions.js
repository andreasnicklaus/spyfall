...
export class Instructions extends Component {
    ...
    render() {
        return <div>
            ...
            <Box sx={{ m: 2 }}>
                <Typography><b>Welcome, Agent!</b></Typography>

                <Typography>You're a detective, but someone in your department is an enemy
                    spy. Everyone is invited to a social gathering. Everyone but the spy has gotten
                    the invitation.</Typography>

                <Typography>Your job is it to discover which player is the spy and save the integrity of
                    you whole organisation.</Typography>
                ...
                <ul>
                    <li><Typography><b>The location:</b> At the start of each round, a location of the gathering is chosen.
                    ...
                    <li><Typography><b>Questioning:</b> The game leader (organizer or the spy of the previous round) start by
                        questioning another player about the location. Example: "Do you think I can bring my partner?"
                    </Typography></li>
                    <li><Typography><b>Answering:</b> The questioned player must answer. Follow-up questions are not allowed.
                    ...
                    <li><Typography><b>No retaliation:</b> It is not allowed to pose a question to a player who just interrogated
                ...
                <Typography>There are 3 ways the round can end:</Typography>

                <ol>
                    <li><Typography><b>No time left:</b> When the clock runs out, the spy remains undercover and wins the round.
                        He/She can now reveal himself/herself.
                    </Typography></li>
                    <li><Typography><b>Spy guess:</b> If at any point during the round the spy is certain to have found out the
                        round's
                    ...
                    <li><Typography><b>Indictment:</b> The players can indict another player in a unanimous vote. If they cannot
                        come
                ...
                <Typography><b>Optional rule:</b> An indicted spy can still win if he/she has found out the location.</Typography>
                ...
                <Typography>... for the spy</Typography>
                ...
                <Typography>... for each non-spy player.</Typography>

                <Typography variant={"h5"}>Total score</Typography>

                <Typography>You can play as many rounds as you want. The player with the most points wins the overall game.</Typography>
            </Box>
        </div>
    }
}